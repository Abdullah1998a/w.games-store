    ...
    <div className="info flex justify-between">
      <div>
        ...
        <div className="flex gap-6 items-center">
          <button className="flex items-center gap-3 px-6 py-1.5 bg-stone-300 rounded-md">
            <span className="pe-3 border-e-[1px] border-slate-700">
              Buy now
            </span>
            <svg
          ...
          <div>
            <span className="text-xl font-medium me-2">$500</span>
            <span className="text-sm text-gray-600 line-through">$1200</span>
          </div>
        </div>
      </div>
      <div>
